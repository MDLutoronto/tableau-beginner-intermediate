...
* [Creating Bar Graphs](#bar_graphs)
* [Creating Line Graphs](#line_graphs)
* [Creating Gantt Charts](#gantt_charts)
* [Creating Highlight Tables](#highlight_tables)
* [Creating Histograms](#histograms)
* [Creating Box Plots](#box_plots)
* [Creating Scatter Plots](#scatter_plots)
* [Creating Pie Charts](#pie_charts)
* [Creating Stacked Bar Graphs](#stacked_bar)
* [Creating Tree Maps](#tree_maps)
* [Creating Choropleth Maps](#choropleth_maps)
* [Creating Proportional Symbol Maps](#proportional_symbol_maps)
* [Creating Dashboards](#dashboards)
* [Creating Stories](#stories)
...
![The Country/Region variable in the Dimensions section and the Text box in the Marks card are highlighted.]({{ '/assets/images/tableau_b2i_100a.jpg' | relative_url }})

Next, **drag the Population Total variable** (**Measures**, under **Population**) on to the **Size** box on the **Marks** card, as we’re going to size these regions blocks by their population.

![The Population Total variable in the Measures sections with the Size box in the Marks card both highlighted.]({{ '/assets/images/tableau_b2i_100b.jpg' | relative_url }})
...
Technique: [Data Visualization](/technique/data-visualization) \| Tools: [Tableau](/tools/tableau)**Date Created:** 2020\-03\-25**Updated:** 2022\-12\-15
